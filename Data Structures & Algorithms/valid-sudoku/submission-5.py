    ...
    def isValidSudoku(self, board: List[List[str]]) -> bool:
        ...
        for i in range(9):
            for j in range(9):
                ...
                #create a binary mask by shifting 1 by (cell value - 1) places to fit 0-indexed bits.
                #e.g. if cell = "5", shift by 4 places, mask = 00010000 (representing the 5th digit)
                mask = 1 << int(cell) - 1
                square = i // 3 * 3 + j // 3
